...
import com.kidozone.entity.SchoolInfo;
...
public class SchoolInfoFacadeREST extends AbstractFacade<SchoolInfo> {

    @PersistenceContext(unitName = "HellofitWebServerPU")
    private EntityManager em;

    public SchoolInfoFacadeREST() {
    ...
    public void create(SchoolInfo entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, SchoolInfo entity) {
        super.edit(entity);
    }
    ...
    public SchoolInfo find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<SchoolInfo> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
